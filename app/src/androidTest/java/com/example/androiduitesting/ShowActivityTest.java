...
public class ShowActivityTest {
     ...
     * This test verifies that clicking on a city in the list
     * launches the ShowActivity
     */
    @Test
    public void testActivitySwitch() {
        ...
        // Verify that ShowActivity was launched by checking if an intent
        // to ShowActivity was sent
     ...
     * matches the city that was clicked in MainActivity
     */
    @Test
     ...
     * returns to MainActivity and the city list is still visible
     */
    @Test
    public void testBackButton() {
        String testCity = "Montreal";
        ...
        // Click on the city in the list to go to ShowActivity
        onData(is(instanceOf(String.class)))
                .inAdapterView(withId(R.id.city_list))
                .atPosition(0)
                .perform(click());
        ...
        // Verify we're back in MainActivity by checking if the city list is visible
        onView(withId(R.id.city_list)).check(matches(isDisplayed()));

        // Also verify that our city is still in the list
